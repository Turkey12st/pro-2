  ...
  public: {
    Tables: {
      ...
      data_sync_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "data_sync_log_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      employee_salaries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "employee_salaries_payroll_cycle_id_fkey"
      ...
      salary_components: {
        Row: {
          ...
          id: string
          is_active: boolean
          is_gosi_applicable: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "salary_components_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "chart_of_accounts"
            referencedColumns: ["id"]
      ...
      salary_details: {
        ...
        Relationships: [
          {
            foreignKeyName: "salary_details_component_id_fkey"
          ...
          {
            foreignKeyName: "salary_details_employee_salary_id_fkey"
    ...
    Functions: {
      ...
      get_default_company: { Args: { _user_id: string }; Returns: string }
